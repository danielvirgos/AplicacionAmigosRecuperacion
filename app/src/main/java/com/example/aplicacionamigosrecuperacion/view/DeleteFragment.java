...
public class DeleteFragment extends Fragment {
    ...
    private void init(View view) {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recyclerViewDelete);
        DeleteRecyclerViewAdapter amigosRecyclerViewAdapter = new DeleteRecyclerViewAdapter(amigos, getContext());
